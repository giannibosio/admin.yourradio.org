...
<nav class="vertnav navbar navbar-light">
          ...
          <div class="w-100 mb-4 d-flex">
            <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="./index.php">
              <img src="./assets/images/logo-yourradio-maxi.png" alt="Yourradio" height="70"> 
            </a>
          </div>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="dashboard">
                <li class="nav-item active">
                  <a class="nav-link pl-3" href="./index.php"><span class="ml-1 item-text">Dashboard</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="./monitor.php"><span class="ml-1 item-text">Monitor</span></a>
                </li>
